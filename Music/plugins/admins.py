...
@PbxBot.app.on_message(filters.command("auth") & filters.group & ~Config.BANNED_USERS)
@check_mode
@AdminWrapper
    ...
    if not message.reply_to_message:
        if len(message.command) != 2:
            return await message.reply_text(
                "ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ ᴏʀ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴜsᴇʀ ɪᴅ ᴏʀ ᴜsᴇʀɴᴀᴍᴇ"
            )
        ...
        if count == 30:
            return await message.reply_text(
                "**ᴀᴜᴛʜ ʟɪsᴛ ɪs ꜰᴜʟʟ!** \n\nʟɪᴍɪᴛ ᴏꜰ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀs ɪɴ ᴀ ᴄʜᴀᴛ: `30`"
            )
        ...
        if not is_auth:
            ...
            await message.reply_text("**sᴜᴄᴄᴇssꜰᴜʟʟʏ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀ ɪɴ ᴛʜɪs ᴄʜᴀᴛ!**")
        
        else:
            await message.reply_text("**ᴛʜɪs ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ɪɴ ᴛʜɪs ᴄʜᴀᴛ!**")
...
async def unauth(_, message: Message):
    ...
    if not message.reply_to_message:
        ...
        if is_auth:
            ...
            await message.reply_text("**ʀᴇᴍᴏᴠᴇᴅ ᴜsᴇʀ's ᴀᴜᴛʜᴏʀɪᴢᴀᴛɪᴏɴ ꜰʀᴏᴍ ᴛʜɪs ᴄʜᴀᴛ!**")
        
        else:
            await message.reply_text("**ᴛʜɪs ᴜsᴇʀ ᴡᴀs ɴᴏᴛ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ɪɴ ᴛʜɪs ᴄʜᴀᴛ!**")
...
async def authusers(_, message: Message):
    ...
    if not all_auths:
        await message.reply_text("**ɴᴏ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀs ɪɴ ᴛʜɪs ᴄʜᴀᴛ!**")
    
    else:
        Pbx = await message.reply_text("ꜰᴇᴛᴄʜɪɴɢ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀs ɪɴ ᴛʜɪs ᴄʜᴀᴛ...")
        ...
        await MakePages.authusers_page(Pbx, rand_key, 0, 0, True)
...
async def settings(_, message: Message):
    ...
    if len(message.command) != 2:
        return await message.reply_text(
            f"**ᴄᴜʀʀᴇɴᴛ ᴀᴜᴛʜᴄʜᴀᴛ sᴛᴀᴛᴜs:** `{'ᴏɴ' if is_auth else 'ᴏꜰꜰ'}`\n\n**ᴜsᴀɢᴇ:** `/authchat on` ᴏʀ `/authchat off`"
        )
    
    if message.command[1].lower() == "on":
        if is_auth:
            await message.reply_text("**ᴀᴜᴛʜᴄʜᴀᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴏɴ!**")
        
        else:
            await db.add_authchat(message.chat.id)
            await message.reply_text(
                "**ᴛᴜʀɴᴇᴅ ᴏɴ ᴀᴜᴛʜᴄʜᴀᴛ!** \n\nɴᴏᴡ ᴀʟʟ ᴜsᴇʀs ᴄᴀɴ ᴜsᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs ɪɴ ᴛʜɪs ᴄʜᴀᴛ!"
            )
        ...
        if is_auth:
            ...
            await message.reply_text(
                "**ᴛᴜʀɴᴇᴅ ᴏꜰꜰ ᴀᴜᴛʜᴄʜᴀᴛ!** \n\nɴᴏᴡ ᴏɴʟʏ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀs ᴄᴀɴ ᴜsᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs ɪɴ ᴛʜɪs ᴄʜᴀᴛ!"
            )
        
        else:
            await message.reply_text("**ᴀᴜᴛʜᴄʜᴀᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴏꜰꜰ!**")
...
@PbxBot.app.on_callback_query(filters.regex(r"authus") & ~Config.BANNED_USERS)
